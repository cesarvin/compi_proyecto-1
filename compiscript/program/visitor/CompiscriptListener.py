...
class CompiscriptListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by CompiscriptParser#literal.
    def enterLiteral(self, ctx:CompiscriptParser.LiteralContext):
        pass

    # Exit a parse tree produced by CompiscriptParser#literal.
    def exitLiteral(self, ctx:CompiscriptParser.LiteralContext):
        pass
